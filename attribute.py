...
class Attribute(object):
    ...
    def uploadData(self):
        ...
        # select buffer used by the followingfunctions
    ...
    def associateVariable(self, programRef, variableName):
        ...
        print(f"Associando variável {variableName} com referência {variableRef}")
        
        # if the program does not reference the variable, then exit
        if variableRef == -1:
            return Exception(f"Variável {variableName} não encontrada no programa.")
